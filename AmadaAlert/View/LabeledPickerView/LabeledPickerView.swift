...
protocol LabeledPickerViewDelegate {
    func labeledPickerViewRowSelected(_ pickerView: UIPickerView, row: Int, inComponent component: Int, pickerViewModel: PickerViewModel)
}
...
class LabeledPickerView: UIView {
    ...
    private func initializeView() {
        ...
        toolbarDoneButton.action = #selector(handleDone)
